...
@section('title', 'Timeline - Documentation des Composants')
...
<div class="mb-8">
    <div class="flex items-center mb-4">
        ...
        <div>
            ...
            <p class="text-gray-600">Composant Timeline réutilisable avec options configurables</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div class="bg-gray-50 rounded-lg p-8 mb-6 flex items-center justify-center">
            <div class="text-center">
                <p class="text-gray-600">Preview du composant Timeline</p>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div class="space-y-6">
            <div>
                ...
                <div class="space-y-3">
                    <p class="text-gray-600">Exemples du composant Timeline à venir</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto"><code class="language-html">&lt;x-timeline&gt;Contenu&lt;/x-timeline&gt;</code></pre>
            </div>

            <!-- With Props -->
            <div>
                <h4 class="font-medium text-gray-900 mb-3">Avec Propriétés</h4>
                <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto"><code class="language-html">&lt;x-timeline 
    prop1="value1"
    prop2="value2"
&gt;
    Contenu
